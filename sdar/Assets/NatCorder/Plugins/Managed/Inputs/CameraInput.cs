    ...
    public sealed class CameraInput : IDisposable {
        ...
        public CameraInput (IMediaRecorder mediaRecorder, IClock clock, params Camera[] cameras) {
            ...
            if (Application.platform == RuntimePlatform.Android)
                readback = new GLESReadback();
            else if (Application.platform == RuntimePlatform.IPhonePlayer)
                readback = new MTLReadback();
            else if (SystemInfo.supportsAsyncGPUReadback)
                readback = new AsyncReadback();
            else
                readback = new SyncReadback();
            // Create framebuffer
        ...
        private readonly IReadback readback;
        ...
        private IEnumerator OnFrame () {
            ...
            for (;;) {
                ...
                if (recordFrame) {
                    ...
                    readback.Readback(framebuffer, pixelBuffer => mediaRecorder.CommitFrame(pixelBuffer, timestamp));
                }
            }
        }
